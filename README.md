# WPoster - WordPress文章发布CLI工具

一个用Go编写的Windows命令行工具，用于管理和发布markdown格式的WordPress文章，支持中文内容、Markdown转换和交互式操作。
...
目前是测试版本，仅开发了检索文章和发布文章功能。欢迎提交PR！
...
目前是测试版本，仅开发了检索文章和发布文章功能。欢迎提交Issue和Pull Request！
